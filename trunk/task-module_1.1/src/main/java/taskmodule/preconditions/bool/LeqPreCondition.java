 ...
 *
 */
public class LeqPreCondition implements IBoolPreCondition {

	private static final long serialVersionUID = -1323074634238333497L;
	...
	public LeqPreCondition(IPreCondition op1, IPreCondition op2) {
		this.op1 = op1;
		this.op2 = op2;
	}
}
