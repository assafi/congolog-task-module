 ...
 *
 */
public class DividePreCondition implements IIntPreCondition {

	private static final long serialVersionUID = -4207361488920761356L;
	...
	public DividePreCondition(IPreCondition op1, IPreCondition op2) {
		this.op1 = op1;
		this.op2 = op2;
	}
}
